...
class PseudosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pseudo" do
    assert_difference("Pseudo.count") do
      post pseudos_url, params: { pseudo: { body: @pseudo.body, name: @pseudo.name, user_id: @pseudo.user_id } }
    end
  ...
  test "should update pseudo" do
    patch pseudo_url(@pseudo), params: { pseudo: { body: @pseudo.body, name: @pseudo.name, user_id: @pseudo.user_id } }
